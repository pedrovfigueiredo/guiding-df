...
enum class ErrorMetric { MSE, MAPE, SMAPE, RelMSE, RelMSEEpsilon, Count };
...
KRR_ENUM_DEFINE(ErrorMetric, {
	...
	{ErrorMetric::RelMSEEpsilon, "rel_mse_epsilon"}
});
...
float calc_metric_relmse_epsilon(const Color4f *frame, const Color4f *reference, size_t n_elements);
